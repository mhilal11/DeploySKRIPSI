...
interface LetterDetailDialogProps {
  ...
  detailTab: 'detail' | 'tracking';
  onDetailTabChange: (value: 'detail' | 'tracking') => void;
  onOpenReply: () => void;
}
        ...
        <div className="max-h-[calc(85vh-4.5rem)] overflow-y-auto">
          {letter ? (
            <div className="px-6 pb-8 pt-4">
              ...
              <p className="mt-1 text-xs text-slate-500">Diterima pada {letter.date}</p>
              {letter.isFinalized && (
              ...
              <Tabs
                value={detailTab}
                onValueChange={(value) => onDetailTabChange(value as 'detail' | 'tracking')}
                  ...
                  <div className="space-y-5">
                    <Card className="overflow-hidden border-slate-200">
                      ...
                      <div className="grid gap-4 p-5 text-sm md:grid-cols-3">
                        ...
                        <InfoTile label="Tanggal" value={letter.date} />
