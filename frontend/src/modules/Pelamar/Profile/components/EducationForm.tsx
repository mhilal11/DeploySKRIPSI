...
export default function EducationForm({
      ...
      void (async () => {
        try {
          const response = await api.get(
            apiUrl("/pelamar/references/education"),
            {
          ...
          setInstitutionOptions([]);
          setReferenceError(
            "Referensi kampus/prodi belum tersedia. Silakan isi manual.",
          );
        }
      })();
    }, 300);
  ...
  const handleStartYearChange = (
    ...
    if (endYear > maxEndYear) {
      ...
      toast.info(
        "Tahun selesai disesuaikan maksimal 7 tahun dari tahun mulai.",
      );
    }
  };
    ...
    <Card className="p-6">
      ...
      <div className="space-y-4">
        {educations.map((education, index) => (
          <div
            key={
              education.id && education.id.trim() !== ""
                ? education.id
                : `education-${index}`
            }
          ...
          >
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
              <div className="md:col-span-2">
                <Label>
                  <RequiredLabel text="Nama Institusi" />
                </Label>
                <AutocompleteInput
                ...
                <p className="mt-1 text-xs text-slate-500">
                  Ketik minimal {MIN_SEARCH_CHARACTERS} karakter. Tetap bisa isi
                  manual jika institusi belum tersedia.
                </p>
                {referenceError && (
              ...
              <div>
                <Label>
                  <RequiredLabel text="Program Studi" />
                </Label>
                <AutocompleteInput
              ...
              <div>
                <Label>
                  <RequiredLabel text="Tahun Mulai" />
                </Label>
                <YearPickerInput
              ...
              <div>
                <Label>
                  <RequiredLabel text="Tahun Selesai" />
                </Label>
                <YearPickerInput
                ...
                />
                <p className="mt-1 text-xs text-slate-500">
                  Minimal mengikuti tahun mulai, maksimal 7 tahun dari tahun
                  mulai
                </p>
        ...
        <div className="mt-6">
          ...
          {!processing && !hasChanges && (
            <p className="mt-2 text-sm text-slate-500">
              Ubah minimal 1 field pendidikan terlebih dahulu agar tombol simpan
              aktif.
            </p>
          )}
        </div>
