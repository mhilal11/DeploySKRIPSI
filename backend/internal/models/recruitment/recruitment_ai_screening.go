...
type RecruitmentAIScreening struct {
	...
	ModelChain             modeltypes.JSON `db:"model_chain" json:"model_chain"`
	...
	StrengthsJSON          modeltypes.JSON `db:"strengths_json" json:"strengths_json"`
	GapsJSON               modeltypes.JSON `db:"gaps_json" json:"gaps_json"`
	RedFlagsJSON           modeltypes.JSON `db:"red_flags_json" json:"red_flags_json"`
	InterviewQuestionsJSON modeltypes.JSON `db:"interview_questions_json" json:"interview_questions_json"`
	...
	AttemptsJSON           modeltypes.JSON `db:"attempts_json" json:"attempts_json"`
	RawResponse            modeltypes.JSON `db:"raw_response" json:"raw_response"`
